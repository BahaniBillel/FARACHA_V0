...
function BottomNavigationBar() {
  ...
  return (
    <div
      className={`flex justify-center md:hidden flex-row space-x-8 bg-white border-t py-3 fixed bottom-0 left-0 w-full shadow-md px-2 transition-transform duration-300 ${
